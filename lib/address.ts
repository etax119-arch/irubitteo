/** 한국 시/도 → 시/군/구 매핑 데이터 */
export const KOREA_ADDRESS_DATA: Record<string, string[]> = {
  서울특별시: [
...
/** 시/도 목록 */
export const CITY_OPTIONS = Object.keys(KOREA_ADDRESS_DATA);

/** 선택된 시/도에 해당하는 군/구 목록 반환 */
export function getDistrictOptions(city: string): string[] {
  return KOREA_ADDRESS_DATA[city] ?? [];
}
