...
function AnnouncementThumbnail({ item }: { item: AnnouncementItem }) {
  ...
  return (
    <div className="relative aspect-[16/9] bg-duru-orange-50 overflow-hidden">
      {cover ? (
        <Image
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <Megaphone aria-hidden className="w-10 h-10 text-landing-orange/60" />
        </div>
      )}
    </div>
  );
  ...
  return (
    <section ref={sectionRef} className="py-24 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <span className="inline-flex items-center gap-1.5 rounded-full bg-duru-orange-50 px-4 py-1.5 text-sm font-semibold text-landing-orange mb-4">
            <Megaphone aria-hidden className="w-4 h-4" />
            채용 공고
          </span>
            ...
            return (
              ...
              >
                <Link
                  ...
                  className="group block h-full rounded-2xl bg-white border border-duru-orange-100 shadow-soft overflow-hidden transition-all duration-300 hover:shadow-md hover:-translate-y-1 hover:border-duru-orange-200 focus:outline-none focus:ring-2 focus:ring-duru-orange-500 focus:ring-offset-2"
                >
                  ...
                  <div className="p-5">
                    ...
                    <p className="mt-1.5 text-sm text-duru-text-sub break-keep leading-relaxed line-clamp-2">
                      {item.content}
                    </p>
                  </div>
                </Link>
