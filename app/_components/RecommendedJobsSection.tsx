...
const JOBS: Job[] = [
  ...
  { id: 'art', title: '미술', example: '달력 제작, 삽화 그림', icon: Paintbrush, image: '/images/jobs/job-6.png', imageAlt: '미술 일러스트 — 그림이 그려진 달력과 붓' },
  ...
  { id: 'promo-goods', title: '홍보물 제작', example: '홍보 물품 제작 업무', icon: Gift, image: '/images/jobs/job-12.png', imageAlt: '홍보물 제작 일러스트 — 에코백과 텀블러' },
];
...
export default function RecommendedJobsSection() {
  ...
  return (
    <section ref={sectionRef} className="min-h-screen flex items-center py-32 bg-duru-orange-50">
