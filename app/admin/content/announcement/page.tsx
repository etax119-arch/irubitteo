...
import { useAdminAnnouncements } from '../../_hooks/useAnnouncementQuery';
import { useCreateAnnouncement, useUpdateAnnouncement, useDeleteAnnouncement } from '../../_hooks/useAnnouncementMutations';
import type { AnnouncementItem, AnnouncementUpdateInput } from '@/types/announcement';
import AnnouncementAdminCard from '../_components/AnnouncementAdminCard';
  ...
  return (
    <div className="space-y-4">
      ...
      {announcements.length === 0 ? (
        <div className="text-center py-16 text-gray-400">등록된 공고가 없습니다.</div>
      ) : (
